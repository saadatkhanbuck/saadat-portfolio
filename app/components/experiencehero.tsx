        ...
        <div className="grid w-full grid-cols-1 items-center gap-24 md:grid-cols-2">
          ...
          <div className="text-center md:text-left">
            ...
            >
              <Link
                href="/contactme"
                className="group relative border border-black dark:border-white inline-flex items-center justify-center gap-2 overflow-hidden rounded-xl bg-neutral-900 px-8 py-3 font-medium text-white"
              >
            ...
            >
              {[
                ...
                <div key={item.label}>
                  <p className="text-3xl dark:text-neutral-300 font-semibold">
                    {item.value}
                  </p>
          ...
          >
            ...
            >
              ...
              <p className="text-sm font-semibold">Working on live client projects</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
